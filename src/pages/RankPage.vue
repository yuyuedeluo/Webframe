...
.score-bar__fill{ height:100%; background: linear-gradient(90deg, #7fb2ff, #f08d8d); }
...
/* ===== 清單中使用者高亮 ===== */
.userRow{
  border-left: 4px solid #ed763b;
  background: linear-gradient(90deg, rgba(255, 19, 19, 0.1), rgba(255,255,255,.9));
}
</style>
